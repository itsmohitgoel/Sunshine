...
public class RegistrationIntentService extends IntentService {
    ...
    protected void onHandleIntent(Intent intent) {
        ...
        try {
            ...
            synchronized (LOG_TAG) {
                ...
                // sent to your server. If the boolean is false, send the token to the server,
    ...
    /**
     * Normally, you would want to persist the registration token to the servers. Because we do not
     * have a server, and are faking it with a website, you'll want to log the token instead.
     * That way you can see the value in the logcat, and note it for future use in the website.
     *
