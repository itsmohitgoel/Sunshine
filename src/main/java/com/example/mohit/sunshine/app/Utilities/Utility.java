...
//        return String.format("%.0f", temp);
    ...
    public static String getFormattedWind(Context context, float windSpeed, float degrees) {
        ...
        if (Utility.isMetric(context)) {
            windFormat = R.string.format_wind_kmph;
        } else {
...
//        return String.format(context.getString(windFormat), windSpeed, direction);
     ...
     */
    public static int getIconResourceForWeather(int weatherId) {
     ...
     * @return resource id of the corresponding image. -1 if no relation found.
     */
    public static int getArtResourceForWeather(int weatherId) {
        // Based on weather code found at:
        // http://openweathermap.org/weather-conditions
        if (weatherId >= 200 && weatherId <= 232) {
